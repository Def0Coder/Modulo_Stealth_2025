...
void EmptyLinkFunctionForGeneratedCodeModulo_Stealth_Cpp_init() {}
	static FPackageRegistrationInfo Z_Registration_Info_UPackage__Script_Modulo_Stealth_Cpp;
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_Modulo_Stealth_Cpp()
	{
		if (!Z_Registration_Info_UPackage__Script_Modulo_Stealth_Cpp.OuterSingleton)
		{
			static const UECodeGen_Private::FPackageParams PackageParams = {
				"/Script/Modulo_Stealth_Cpp",
				nullptr,
				0,
